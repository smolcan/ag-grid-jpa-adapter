...
const PaginationGrid = () => {
    ...
    const serverSideDatasource: IServerSideDatasource = useMemo(() => ({
        getRows: (params) => {
            const dataRequest = fetch('https://ag-grid-jpa-adapter-docs-backend.onrender.com/docs/pagination/getRows', {
                method: 'POST',
                headers: {
            ...
            if (pagination && refetchRowCount) {
                const countRequest = fetch('https://ag-grid-jpa-adapter-docs-backend.onrender.com/docs/pagination/countRows', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
