...
const RowCountInResponseGrid = () => {
    ...
    const serverSideDatasource: IServerSideDatasource = useMemo(() => ({
        getRows: (params) => {
            // one request only: rowCount comes back inside LoadSuccessParams
            fetch(`${API_URL}/docs/pagination/row-count-in-response/getRows`, {
                method: 'POST',
                headers: {
...
export default RowCountInResponseGrid;
