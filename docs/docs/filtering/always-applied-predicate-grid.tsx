...
const AlwaysAppliedPredicateGrid = () => {
        ...
        },
        {
            ...
            filterParams: {
                values: params => {
                    ...
                    fetch(`${API_URL}/docs/filtering/always-applied-predicate/supplySetFilterValues/${field}`, {
                        method: 'GET',
                        headers: {
    ...
    const serverSideDatasource: IServerSideDatasource = useMemo(() => ({
        getRows: (params) => {
            fetch(`${API_URL}/docs/filtering/always-applied-predicate/getRows`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
...
export default AlwaysAppliedPredicateGrid;
