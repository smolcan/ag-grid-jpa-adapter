...
import {
    ...
    NumberFilterModule, RowGroupingPanelModule,
...
ModuleRegistry.registerModules([ServerSideRowModelModule, NumberFilterModule, TextFilterModule, ValidationModule, ColumnAutoSizeModule, EventApiModule, RowGroupingPanelModule, SetFilterModule]);

const GrandTotalRowGrid = () => {
        ...
        },
        {
            ...
            filterParams: {
                values: params => {
                    ...
                    fetch(`${API_URL}/docs/grand-total-row/supplySetFilterValues/${field}`, {
                        method: 'GET',
                        headers: {
...
export default GrandTotalRowGrid;
