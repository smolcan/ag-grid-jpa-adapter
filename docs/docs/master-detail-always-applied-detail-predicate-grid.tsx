...
const MasterDetailAlwaysAppliedDetailPredicateGrid = () => {
    ...
    const serverSideDatasource: IServerSideDatasource = useMemo(() => ({
        getRows: (params) => {
            fetch(`${API_URL}/docs/master-detail/always-applied-detail-predicate/getRows`, {
                method: 'POST',
                headers: {
        ...
        return (params: ICellRendererParams): IDetailCellRendererParams => {
            ...
            return {
                ...
                getDetailRowData: (params: GetDetailRowDataParams) => {
                    ...
                    fetch(`${API_URL}/docs/master-detail/always-applied-detail-predicate/getDetailRowData`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
...
export default MasterDetailAlwaysAppliedDetailPredicateGrid;